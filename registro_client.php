<?php
    ...
    if(isset($_POST['razon']) && isset($_POST['rfcu'])){
        ...
        if($row = $resultado->fetch_array()){
            ...
            $insert = "INSERT INTO empresa(razon_social, nombre_comercial, rfc, dirección_fiscal, url_pagina_Web, url_red_social, dir_oficinas_principales) 
            VALUES ('$razon','$ncomercial','$rfc','$dfiscal','$web','$redsocial','$ofprincipales')";
            ...
            if($query){
                ...
                VALUES ('$rfcu','$nombre','$papellido','$sapellido','$correo','$pass','$cel',2,2,'$razon')";
                $query = mysqli_query($conect,$insert);
                if($query){
                  echo '<div class="container">
...
<html>
    ...
    <title>Registro Clientes | Social Truck</title>
