...
<main class="d-flex flex-nowrap">
  ...
  <div class="b-example-divider b-example-vr"></div>
    ...
    <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" name="no_serie" id="no_serie" placeholder="" value="" required>
                  ...
                  <div class="col-md-2 mb-2">
                    ...
                    <input type="text" class="form-control" name="capacidad" id="capacidad" placeholder="" value="">
  </div>
                    <div class="col-md-2 mb-2">
                    <label for="dimensiones" class="form-label">Dimensiones</label>
                    <input type="text" class="form-control" name="dimensiones" id="dimensiones" placeholder="" value="">
  </div>
                    <div class="col-md-5 mb-2">
                    <label for="extra" class="form-label">Notas Extra</label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 mb-2">
                        ...
                        <?php
                          include ("conector.php");
                          $consulta = "SELECT id_tipo,tipo FROM tipo_semirremolque";
                          $query = mysqli_query($conect,$consulta);
                          $row = $query->fetch_all();
                          foreach($row as $data){
                            ?>
        ...
        <h4 class="text-center">Mis Semirremolques</h4>
  ...
  <script src="js/script_semi.js"></script>
