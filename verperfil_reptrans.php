...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 250px;">
  ...
  <div class="container">
  <div class="p- p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        ...
        <br>
          ...
          <strong class="d-inline-block mb-2 text-primary-emphasis">Nos especializamos en</strong>
          <p class="card-text mb-auto"><?php echo"$especializacion"?></p>
          <strong class="d-inline-block mb-2 text-primary-emphasis">Nuestras certificaciones</strong>
          <p class="card-text mb-auto"><?php echo"$certificaciones"?></p>
        </div>
        <div class="col-auto d-none d-lg-block">
          <svg class="bd-placeholder-img" width="100" height="450" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
        </div>
      </div>
    </div>
  </div>
