        ...
        <h4>Mis Contratos</h4>
            <table class="table table-hover table-responsive">
                <thead>
                    ...
                    $consulta ="SELECT * FROM viaje WHERE representante_trans_id = '$id_user'";
                    ...
                    while ($row = mysqli_fetch_assoc($resultadoViaje)) {
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                          ...
                          if (isset($_POST['submit_traslado'])) {
                              ...
                              if (move_uploaded_file($archivoTemp, $rutaCompleta)) {
                                  ...
                                  if ($resultadoUViaje) {
                                    echo "<script>
                                    window.location.href='gestioncontratos.php'
                                    </script>";
                            ...
                            $nombreArchivocontratogenerico = "contratogenerico_{$id_viaje}_{$representante_trans_id}_{$transportista_id}_{$representante_cliente}_{$empresa_razon}.pdf";
                            ...
                            if (move_uploaded_file($archivoTemp, $rutaCompletacontratogenerico)) {
                                $query = "UPDATE viaje SET url_cp_contratogenerico = '$rutaCompletacontratogenerico', nompre_contratogenerico = '$nombreArchivocontratogenerico' WHERE id_viaje = $id_viaje";
                                $resultadoUViaje = $conect->query($query);
                                if ($resultadoUViaje) {
                                  echo "<script>
                                  window.location.href='gestioncontratos.php'
                        ...
                        <?php       }
                            ...
                            <button onclick="downloadLocalFile3('http://localhost/PracticasPHP/Social%20Truck/PDFs/ContratoGenerico/<?php echo $nompre_contratogenerico;?>', '<?php echo $nompre_contratogenerico;?>');">Descargar ComprobanteG</button>
