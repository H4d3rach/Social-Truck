...
<main class="d-flex flex-nowrap">
  ...
  <div class="container">
  <form action="operaciones_bd/actualizar_client.php" method="post" id="frm" class="needs-validation" novalidate>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
...
<div class="col-lg-6">
    <div class="card">
        ...
        <hr class="my-4">
        <input type="submit" value="Actualizar perfil" name="registrar" id="registrar" class="w-100 btn btn-primary btn-lg" >
        <?php
        echo"<br><br>
